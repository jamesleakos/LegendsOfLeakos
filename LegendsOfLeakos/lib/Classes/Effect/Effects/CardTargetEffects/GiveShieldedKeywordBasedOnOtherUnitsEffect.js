...
var GiveShieldedKeywordBasedOnOtherUnitsEffect = /** @class */ (function (_super) {
    ...
    function GiveShieldedKeywordBasedOnOtherUnitsEffect(setEffectValues, setTargetTypes) {
        ...
        _this.effectEnum = Effect_1.EffectType.GiveShieldedKeywordBasedOnOtherUnits;
    ...
    GiveShieldedKeywordBasedOnOtherUnitsEffect.prototype.targetTypeInfoList = function () {
        var list = [
            new TargetTypeInfo_1.default('Targets To Be Shielded', 'These are the units that are shielded by this effect. At least one must remain in the targetableZoneIdList as of preEffect to prevent sizzle', 'Targets must be cards', 1, null),
